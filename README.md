...
[![Source Code](http://img.shields.io/badge/source-Kadokcode/router-blue.svg?style=flat-square)](https://github.com/kadokweb/router)
[![PHP from Packagist](https://img.shields.io/packagist/php-v/Kadokcode/router.svg?style=flat-square)](https://packagist.org/packages/Kadokcode/router)
...
[![Total Downloads](https://img.shields.io/packagist/dt/Kadokcode/router.svg?style=flat-square)](https://packagist.org/packages/Kadokcode/router)
...
###### KadokCode is a set of small and optimized PHP components for common tasks. Held by Doka B. Silva and the UpInside team. With them you perform routine tasks with fewer lines, writing less and doing much more.

KadokCode é um conjunto de pequenos e otimizados componentes PHP para tarefas comuns. Mantido por Doka B. Silva e a equipe UpInside. Com eles você executa tarefas rotineiras com poucas linhas, escrevendo menos e fazendo muito mais.
...
<form action="" method="POST">
  ...
  <input type="text" name="email" value="kadokwr@gmail.com" />

  <button>KadokCode</button>
</form>
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://localhost/Kadokcode/router/exemple/spoofing/",
...
###### Security: If you discover any security related issues, please email kadokwr@gmail.com instead of using the issue tracker.

Se você descobrir algum problema relacionado à segurança, envie um e-mail para kadokwr@gmail.com em vez de usar o rastreador de problemas.
...
- [KadokWeb Desenvolvimento](https://github.com/kadokweb) (Team)

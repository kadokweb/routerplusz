...
class Kadok
{
    ...
    public function edit(array $data): void
    {
        ...
        echo "<form name='Kadokcode' method='post' enctype='multipart/form-data'>
            <input name=\"first_name\" value=\"Doka\">
            <input name=\"last_name\" value=\"V. Silva\">
            <input name=\"email\" value=\"kadokwr@gmail.com\">
